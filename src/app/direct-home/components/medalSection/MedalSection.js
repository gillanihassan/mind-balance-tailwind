  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto mt-10 p-4 flex flex-col md:flex-row justify-center items-center">
      <div className="grid md:grid-cols-3 gap-4">
        {/* Block 1 */}
        <div>
          <div className="flex flex-row w-[25rem] bg-[linear-gradient(90deg,_#E3F3F3_25.48%,_rgba(0,130,130,0.2)_100%)] rounded-tl-[12rem] rounded-bl-[12rem] border-none shadow-md overflow-hidden">
            <Image
            ...
            />  
            <div className="flex flex-col justify-center items-center mx-4 text-center">
