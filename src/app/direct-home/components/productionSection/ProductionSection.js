...
export default function ProductionSection() {
  return (
    <div className='p-4 md:p-0'>
      <div className="w-full max-w-[1400px] mx-auto mt-20" >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
          {cardsData.map((card, index) => (
            <Card key={index} className="w-full max-w-[27rem] overflow-hidden shadow-md py-0 rounded-[5px]">
              <Image
                src={card.image}
                width={430}
                height={264}
        ...
        <div className="flex justify-center mt-13">
          <button className="bg-[#e0af54] text-white font-inter font-bold text-base py-3 px-10 rounded hover:brightness-110 transition cursor-pointer ">
            顯示更多
          </button>
        </div>
      </div>
